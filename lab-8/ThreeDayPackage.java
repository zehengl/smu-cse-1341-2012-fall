...
public class ThreeDayPackage extends Package {
	...
	public String toString() {
		return "ThreeDayPackage [calculateCost()=" + calculateCost() + ", prepareMailingLabel()="
				+ prepareMailingLabel() + ", getExtraServices()=" + getExtraServices() + ", getSender()=" + getSender()
				+ ", getRecipient()=" + getRecipient() + ", getWeight()=" + getWeight() + ", getCostPerOunce()="
				+ getCostPerOunce() + ", getPackageValue()=" + getPackageValue() + ", toString()=" + super.toString()
