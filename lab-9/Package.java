...
public abstract class Package {
  ...
  /**
   * Builds a Package Mailing Label File Name. Gets the next file name to print
   * the mailing label - the format is: FILE_NAME + mailingLabelIndex + "." +
   * FILE_TYPE Then increase the mailingLabelIndex in preparation for building the
   * next mailing label file name.
   */
